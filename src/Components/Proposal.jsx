...
import { FaSearch, FaBell, FaPowerOff, FaClock, FaPlus } from 'react-icons/fa';
...
const Proposal = () => {
  return (
    <div className="flex h-screen"> {/* Flex container for horizontal layout */}
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            <nav className="text-sm text-gray-500">
              <Link to="/" className="hover:underline"><span className="text-xl font-semibold text-black">Proposal Template </span>Home</Link> <span>•</span> Proposal
            </nav>
          </div>
      ...
      <div className="mb-4">
        <button className="bg-orange-500 text-white px-4 py-2 flex rounded hover:bg-orange-600">
          <FaPlus style={{marginTop:"4px",marginRight:"4px"}}/>
